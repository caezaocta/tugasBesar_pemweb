            ...
            <div class="col-12">
                ...
                <form method="post" action="/skptargets">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" id="id_periode"
                            name="id_periode">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="id_uraian_pekerjaan_jabatan">Uraian Pekerjaan</label>
                        <select class="form-select" aria-label="Default select example" id="id_uraian_pekerjaan_jabatan"
                            name="id_uraian_pekerjaan_jabatan">
                    ...
                    {{-- <input type="submit" class="btn btn-primary rounded-pill" value="Tambah"> --}}
